...
ActiveRecord::Schema.define(version: 20_170_223_220_959) do
  ...
  create_table 'albums', force: :cascade do |t|
    ...
    t.index %w(album_dir_id name), name: 'index_albums_on_album_dir_id_and_name', unique: true, using: :btree
  end
  ...
  create_table 'audio_files', force: :cascade do |t|
    ...
    t.index %w(file_dir_id filename), name: 'index_audio_files_on_file_dir_id_and_filename', unique: true, using: :btree
  ...
  create_table 'audio_files_tags', force: :cascade do |t|
    ...
    t.datetime 'created_at',    null: false
    t.datetime 'updated_at',    null: false
    t.index %w(audio_file_id tag_id), name: 'index_audio_files_tags_on_audio_file_id_and_tag_id', unique: true, using: :btree
  ...
  create_table 'list_heads', force: :cascade do |t|
    ...
    t.datetime 'created_at',                 null: false
    t.datetime 'updated_at',                 null: false
    t.index %w(user_id name), name: 'index_list_heads_on_user_id_and_name', unique: true, using: :btree
  ...
  create_table 'list_nodes', force: :cascade do |t|
    ...
    t.datetime 'created_at',     null: false
    t.datetime 'updated_at',     null: false
    t.index %w(listable_id listable_type), name: 'index_list_nodes_on_listable_id_and_listable_type', using: :btree
    t.index %w(listable_type listable_id), name: 'index_list_nodes_on_listable_type_and_listable_id', using: :btree
  end
  ...
  create_table 'lyrics', force: :cascade do |t|
    ...
    t.datetime 'created_at',             null: false
    t.datetime 'updated_at',             null: false
    t.index %w(artist_id song_id), name: 'index_lyrics_on_artist_id_and_song_id', unique: true, using: :btree
  ...
  create_table 'tags', force: :cascade do |t|
    ...
    t.datetime 'created_at',           null: false
    t.datetime 'updated_at',           null: false
    t.index %w(name value), name: 'index_tags_on_name_and_value', unique: true, using: :btree
  end
